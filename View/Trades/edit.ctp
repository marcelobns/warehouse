        ...
        <fieldset>
            ...
            switch($order['OrderType']['trade_mode']){
                case 'select' :
                    ...
                    echo $this->Form->hidden('Stock.units');
                ...
                case 'create' :
                    ...
                    echo $this->Form->input('Trade.price', array('type'=>'number', 'step'=>0.01, 'required'=>'required', 'style'=>'width: 30%'));
                    if(!$isBuy) {
                        echo $this->Form->input('Trade.stock_situation_id', array('empty'=>__('Select an Item...'), 'required'=>'required'));
                    }
                    break;
                case 'num' :
                ?>
...
<script type="text/javascript">
    ...
    function getStock(){
        ...
        $('#TradeStockCode').blur(function(){
            $('#TradeStockId').selectize('val', $('#TradeStockCode').val());
            getStock();
        });
